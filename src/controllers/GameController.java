...
public class GameController {
    ...
    public void run() {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 'Q':
                    InputHelper inputHelper = new InputHelper();
                    String fileName = inputHelper.readString("Enter File Name (e.g. players.txt)");
    ...
    private void updatePlayer() {        
        ...
        Player player = repository.getItem(id);
        int points = inputHelper.readInt("Enter Points Earned") + player.getPointsEarned();
        int level = player.getCurrentLevel()+1;
        player.setPointsEarned(points);
